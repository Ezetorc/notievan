...
describe('ArticlesController', () => {
  ...
  describe('findById', () => {
    it('should return an article by id', async () => {
      ...
      expect(mockResponse.json).toHaveBeenCalledWith(articleMock)
    })
  ...
  describe('delete', () => {
    it('should delete an article by id', async () => {
      const mockRequest = { params: { id: articleMock.id }, user: { id: articleMock.authorId } } as any
      const mockResponse = { json: vi.fn() } as any
      ...
      expect(ArticlesService.delete).toHaveBeenCalledWith(articleMock.id, articleMock.authorId)
    ...
    it('should throw UnauthorizedError if user is not owner of article', async () => {
      ...
      const mockRequest = { params: { id: articleMock.id }, user: { id: userId } } as any
      const mockResponse = { json: vi.fn() } as any
      ...
      expect(ArticlesService.delete).toHaveBeenCalledWith(articleMock.id, userId)
  ...
  describe('update', () => {
    it('should update the article by id', async () => {
      ...
      const mockRequest = { params: { id: articleMock.id }, user: { id: articleMock.authorId }, body: updateArticleDto } as any
      const mockResponse = { json: vi.fn() } as any
      ...
      expect(ArticlesService.update).toHaveBeenCalledWith(articleMock.id, updateArticleDto, articleMock.authorId, undefined)
      expect(mockResponse.json).toHaveBeenCalledWith(true)
    })
  })
  ...
  describe('create', () => {
    it('should create a new article', async () => {
      ...
      const mockRequest = { body: createArticleDto, user: { id: articleMock.authorId } } as any
      const mockResponse = { json: vi.fn(), status: vi.fn().mockReturnThis() } as any
  ...
  describe('getAll', () => {
    it('should return paginated articles', async () => {
      const page = 1
      const limit = 4
      const mockRequest = { query: { page: page.toString(), limit: limit.toString() } } as any
      const mockResponse = { json: vi.fn() } as any
  ...
  describe('getOwn', () => {
    it('should return user-owned paginated articles', async () => {
      const page = 1
      const limit = 4
      const mockRequest = { user: { id: articleMock.authorId }, query: { page: page.toString(), limit: limit.toString() } } as any
      const mockResponse = { json: vi.fn() } as any
      ...
      expect(ArticlesService.getOwn).toHaveBeenCalledWith(limit, skip, mockRequest.user.id)
      expect(mockResponse.json).toHaveBeenCalledWith([articleMock])
    })
  })
