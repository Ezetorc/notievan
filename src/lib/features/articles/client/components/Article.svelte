...
import { isRecent } from 'client/utilities/is-recent.utility'
...
>
    <div
        class="relative aspect-video w-full overflow-hidden rounded-sm bg-gray-100"
    >
    ...
    <div class="mt-4 flex w-full flex-col gap-y-2">
        <div class="flex w-full flex-col gap-y-2">
            ...
            <h3
                class="line-clamp-4 font-title text-4xl wrap-break-word text-black"
            >
                {article.title}
            </h3>
            ...
            <div
                class="mt-2 line-clamp-4 text-[18px] wrap-break-word text-gray-700"
            >
                {article.author.name}
            </div>
        </div>
